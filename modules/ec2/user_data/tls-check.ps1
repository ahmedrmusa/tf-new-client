# This is a demo Powershell script that check .NET Framework and Transport Layer Security (TLS) settings on a Windows system.
# Provided by Okta Support (required for enabling Okta MFA Credentials Provider)
